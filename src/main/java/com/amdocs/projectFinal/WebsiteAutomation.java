...
//			pythonQuiz();
	...
	private static void pythonExercise() {
		...
		//Insert answers in the particular textboxes by using sendKeys() of WebElement class
...
//		searchBox.sendKeys("Python Certificate");
		...
		WebDriverWait wait = new WebDriverWait(dr, new Duration(10, 0));
		...
		dr.findElement(By.xpath("//*[@id=\"shopify-section-template--15923756924985__main\"]/form/div[2]/header/div[2]/button")).click();
	...
	private static void pythonQuiz() {
		...
		List<String> answerIds=Arrays.asList("1","2","4","2","2","2","3","2","1",
				"3","2","4","1","2","3","4","3"
				,"2","1","3","1","2","1","1","2");
